...
- (void)setupChildrenController{
    ...
    BTProductCatagoryListViewController *singleProduct = [[BTProductCatagoryListViewController alloc] init];
    
    [self addChildViewController:singleProduct];
    
    BTShopListCategoryViewController *productList = [[BTShopListCategoryViewController alloc] init];

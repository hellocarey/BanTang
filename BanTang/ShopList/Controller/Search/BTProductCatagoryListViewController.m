...
//
#import "BTTag.h"
#import "BTProductCatagoryListViewController.h"
...
@interface BTProductCatagoryListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BTProductCatagoryListViewController
...
- (void)setupProductListDatasource{
    ...
    [BTProductDataTool productCategoryListData:^(NSMutableArray<BTTag *> *product) {
        
        self.categoryArray = product;
...
- (BTSubProductView *)categoryCategoryView{
    ...
    if(!_categoryCategoryView){
        ...
        _categoryCategoryView.sigleViewBlock = ^(BTTag *tags){
            ...
            BTProductListViewController *singleProduct = [[BTProductListViewController alloc] init];
